...
export const INITIAL_VEHICLES: Vehicle[] = [
  {
    ...
    currentSpeed: 58,
    status: 'Moving',
    statusDuration: '01:24:35',
    fuelLevel: 67,
    fuelCapacity: 350,
    currentFuelLiters: 234,
    lastKnownLocation: 'Chennai Bypass Rd, Maduravoyal',
  ...
  },
  {
    ...
    currentSpeed: 64,
    status: 'Moving',
    statusDuration: '02:11:10',
    fuelLevel: 42,
    fuelCapacity: 400,
    currentFuelLiters: 168,
    lastKnownLocation: 'NH48 Sriperumbudur Expressway',
  ...
  },
  {
    ...
    lastKnownLocation: 'Ennore Port Access Corridor',
 ...
 */
export function simulateTelemetryTick(vehicles: Vehicle[]): Vehicle[] {
